...
while True:
    x=int(input('diga uma coordenada x que vá de 0-2 para revelar!'))
    y=int(input('diga uma coordenada y que vá de 0-2 para revelar!'))
    say = campo(cell)
    
    if say.revelar(campo) == True:
        break
